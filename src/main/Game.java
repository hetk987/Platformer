...
public class Game implements Runnable{
    ...
    public Game(){
        ...
        Surroundings2 surroundingsTest2 = new Surroundings2(collisionWatcher); //creating surroundings and passing collisions
        Player mc = new Player(500, 400, collisionWatcher); //creating a player passing x and y positions and collisions instance
        gamePanel.setBackGround(surroundingsTest, surroundingsTest2);
